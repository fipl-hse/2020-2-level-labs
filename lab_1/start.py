...
if __name__ == '__main__':
    ...
    tokens_frequencies = main.calculate_frequencies(cleaned_tokens)
    third_token = cleaned_tokens[2]
    print(f"Frequency of the third word: {tokens_frequencies[third_token]}")

    top_7_words = main.get_top_n_words(tokens_frequencies, 7)
    print(f"Top 7 words: {top_7_words}")
    ...
    print(f"Part of adjacent words for 'family': {family_adjacent_words[:4]}")
