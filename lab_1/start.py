...
if __name__ == '__main__':
    ...
    sorted_concordance = sort_concordance(tokens, 'sodium', 1, 1, False)

    RESULT = sorted_concordance
    # DO NOT REMOVE NEXT LINE - KEEP IT INTENTIONALLY LAST
    assert RESULT == [['means', 'sodium', 'aluminate'], ['by', 'sodium', 'bicarbonate'], ['epithelial', 'sodium', 'channels'], ['the', 'sodium', 'salt']], 'Concordance not working'
