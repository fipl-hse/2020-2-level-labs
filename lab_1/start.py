...
if __name__ == '__main__':
    ...
    assert RESULT == [[['presented', 'in', 'people', 'who', 'wereare'], ['it', 'but', 'people', 'like', 'the']], [['presented', 'in', 'people', 'who', 'wereare'], ['it', 'but', 'people', 'like', 'the']], [['presented', 'in', 'people', 'who', 'wereare'], ['it', 'but', 'people', 'like', 'the']]], 'Concordance not working'
