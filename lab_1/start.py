...
if __name__ == '__main__':
    ...
    print("tokens without stop words:", tokens_stop_words[:15])
    ...
    print("adjacent words :", adjacent_words[:3])
    ...
    assert RESULT == [['of', 'a'], ['in', 'the'], ['the', 'directive']], 'Concordance not working'
