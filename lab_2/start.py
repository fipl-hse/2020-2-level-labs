...
if __name__ == '__main__':
    ...
    lcs_length = main.find_lcs_length(original_text_tokens, suspicious_text_tokens, plagiarism_threshold=0.3)
    print("Length of the longest common subsequence:", lcs_length)

    matrix = main.fill_lcs_matrix(original_text_tokens, suspicious_text_tokens)

    lcs = main.find_lcs(original_text_tokens, suspicious_text_tokens, matrix)
    ...
    text_plagiarism_score = main.calculate_text_plagiarism_score(original_text_tokens, suspicious_text_tokens, plagiarism_score)
