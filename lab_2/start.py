...
def text_plagiarism_score_for_big_files():
    sentence_tokens_first_text = main.tokenize_big_file(os.path.join(os.getcwd(), 'data.txt'))
    sentence_tokens_second_text = main.tokenize_big_file(os.path.join(os.getcwd(),'data_2.txt'))
