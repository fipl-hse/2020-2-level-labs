...
class CalculatePlagiarismScoreTest(unittest.TestCase):
    ...
    def test_calculate_plagiarism_score_ideal(self):
        """
        Tests that calculate_plagiarism_score function can handle ideal simple input
        """
        lcs_length = 3
    ...
    def test_calculate_plagiarism_score_max(self):
        """
        Tests that calculate_plagiarism_score function can generate max plagiarism correctly
        """
        lcs_length = 4
        suspicious_sentence_tokens = ('the', 'cat', 'is', 'sleeping')
    ...
    def test_calculate_plagiarism_score_min(self):
        """
        Tests that calculate_plagiarism_score function can generate min plagiarism correctly
        """
        lcs_length = 0
        suspicious_sentence_tokens = ('the', 'cat', 'is', 'sleeping')
    ...
    def test_calculate_plagiarism_score_incorrect_lcs_inputs(self):
        """
        Tests that calculate_plagiarism_score function can handle incorrect lcs_matrix inputs
        """
    ...
    def test_calculate_plagiarism_score_incorrect_sentence_input(self):
        """
        Tests that calculate_plagiarism_score function can handle incorrect suspicious_sentence_tokens inputs
        """
    ...
    def test_calculate_plagiarism_score_incorrectly_filled_sentence(self):
        """
        Tests that calculate_plagiarism_score function can handle incorrectly filled sentence
        """
    ...
    def test_calculate_plagiarism_score_empty_sentence(self):
        """
        Tests that calculate_plagiarism_score function can handle empty sentence input
        """
        patches_lcs_length = 2
        sentence = ()
    ...
    def test_calculate_plagiarism_score_check_output(self):
        """
        Tests that calculate_plagiarism_score function can generate correct output according to given specs
        """
        lcs_length = 3
        suspicious_sentence_tokens = ('the', 'cat', 'is', 'sleeping')
    ...
    def test_calculate_plagiarism_score_different_lcs_length(self):
        """
        Tests that calculate_plagiarism_score function can handle bigger lcs_length than given sentence
        """
        lcs_length = 1000000
        suspicious_sentence_tokens = ('the', 'cat', 'is', 'sleeping')
