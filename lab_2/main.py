...
def fill_lcs_matrix(first_sentence_tokens: tuple, second_sentence_tokens: tuple) -> list:
    ...
    :return: a lcs matrix
    """
    if isinstance(first_sentence_tokens,tuple) and isinstance(second_sentence_tokens,tuple) and len(range(first_sentence_tokens))==len(range(second_sentence_tokens)):
