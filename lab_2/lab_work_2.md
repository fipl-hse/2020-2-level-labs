...
Продемонстрируйте использование функций из Шагов 11 – 12 для обработки [data.txt и data_2.txt](https://drive.google.com/drive/folders/1WUvCKNvL0JFRJLfT_yXdANv7bOKB_CUx?usp=sharing) в модуле `start.py`.
