...
if __name__ == '__main__':
    ...
    file_english = open('lab_3/Frank_Baum.txt', encoding='utf-8')
    file_german = open('lab_3/Thomas_Mann.txt', encoding='utf-8')
    file_unknown = open('lab_3/unknown_Arthur_Conan_Doyle.txt', encoding='utf-8')
