...
if __name__ == '__main__':
    ...
    unknown_encoded = lab_3.main.encode_corpus(letter_storage, unknown_text[:100])
    german_encoded = lab_3.main.encode_corpus(letter_storage, german_text[:100])
    english_encoded = lab_3.main.encode_corpus(letter_storage, english_text[:100])
    print('\t...creating n-grams...')
    language_detector = lab_3.main.ProbabilityLanguageDetector((3, 4, 5), 100)
